...
let app = {};
const TOKEN = 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJ1c2VybmFtZSI6InJhaW5oYSIsImlkIjoxLCJpYXQiOjE2MTA0ODE2Nzl9.PWbH9LDpblBftRSqQVjHdQStPYqp2-ofPh_zIU6jxwI';
const headers = {
  Authorization: TOKEN
}
